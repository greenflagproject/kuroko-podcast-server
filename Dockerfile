...
ARG PCS_APP_ROOT_URL="http://localhost:80/"
ENV PCS_APP_ROOT_URL=$PCS_APP_ROOT_URL
...
RUN apt-get update && RUN apt-get install python3 python3-pip vim python3-setuptools -y -qq --no-install-recommends
